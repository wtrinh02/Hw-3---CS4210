    ...
    for shuffle in r: #iterates over r
        ...
        for algorithm in ["Perceptron", "MLP"]: #iterates over the algorithms
            ...
            if accuracy > highest_accuracy['Perceptron']:
                ...
                print(f"Highest Perceptron accuracy so far: {accuracy:.4f}, Parameters: learning rate={lr}, shuffle={shuffle_option}")
            else:  # MLP
                if accuracy > highest_accuracy['MLP']:
                    highest_accuracy['MLP'] = accuracy
                    print(f"Highest MLP accuracy so far: {accuracy:.4f}, Parameters: learning rate={lr}, shuffle={shuffle_option}")
